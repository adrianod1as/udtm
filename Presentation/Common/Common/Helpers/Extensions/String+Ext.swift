...
public extension String {
    ...
    var isBackSpace: Bool {
        return strcmp(self.cString(using: String.Encoding.utf8)!, Domain.L10n.Symbol.backspace) == -92
    }
    ...
    var decimal: Decimal? {
        guard let decimal = self.digits.decimal else {
            return nil
        }
        return decimal / Decimal(pow(10, Double(NumberFormatter.brlBankingCurrency.maximumFractionDigits)))
    }
